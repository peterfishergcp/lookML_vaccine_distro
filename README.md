...
You can find how we did, in the County_14d view, where you can see the lookML model that we used.
...
In order to help Partners learn how to leverage BigQuery ML Models and consume them in Looker, I have included a public ML Model.
...
In BigQuery - I used this model that has two steps. Step 1 is to create the model and the next step is to store the comparison of what was forecasted with actual cases, to better understand how accurate the model is.
